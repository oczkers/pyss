...
setup(
    name=__title__,
    version=__version__,
    description='%s is a simple library for managing Microsoft Smooth Streaming.' % __title__,
    ...
    platforms='any',
    keywords='%s microsoft smooth streaming stream iis isml ismv isma' % __title__,
    packages=packages,
